...
export const PlantcarePage = () => {
  return (
    <div className="w-full overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-15 md:gap-20 lg:gap-50">
        <div className="flex flex-col items-center justify-center gap-4 md:gap-10 px-10 lg:px-0 md:w-200 lg:w-220">
        ...
        <div className="bg-[#E9E2DB] w-full flex flex-col items-center justify-center md:grid grid-cols-2 grid-rows-8 md:items-start md:justify-start py-6 md:py-0 gap-6 md:gap-0 lg:gap-x-11 lg:pl-11 text-center md:text-left">
          <h3 className="font-semibold text-2xl md:text-[32px] md:self-end px-10 lg:px-0 md:pt-10 lg:pt-0">
        ...
        <div className="bg-[#E9E2DB] w-full flex flex-col items-center justify-center md:grid grid-cols-2 grid-rows-7 md:items-start md:justify-start py-6 md:py-0 gap-6 md:gap-0 lg:gap-x-11 lg:pr-11 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start row-start-3 row-span-5 col-start-2 md:h-full md:pb-9 px-10 lg:px-0 order-last md:order-none">
            <h4 className="font-bold text-lg md:text-xl pt-4">
              Yellowing leaves
            </h4>
            <p className="font-light lg:font-normal text-base md:text-lg">
        ...
        <div className="bg-[#E9E2DB] w-full flex flex-col items-center justify-center md:grid grid-cols-2 grid-rows-7 md:items-start md:justify-start py-6 md:py-0 gap-6 md:gap-0 lg:gap-x-11 lg:pl-11 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start row-start-3 row-span-5 md:h-full px-10 lg:px-0 md:pb-9 order-last md:order-none">
            <h4 className="font-bold text-lg md:text-xl md:pt-4">
              <Link to="/product/26">ZZ Plant (Zamioculcas zamiifolia)</Link>
            </h4>
            <p className="font-light lg:font-normal text-base md:text-lg">
            ...
            <h4 className="font-bold text-lg md:text-xl pt-6">
              <Link to="/product/4">Snake Plant (Sansevieria)</Link>
            </h4>
            <p className="font-light lg:font-normal text-base md:text-lg">
            ...
            <h4 className="font-bold text-lg md:text-xl pt-6">
              <Link to="/product/5">Golden Pothos (Epipremnum aureum)</Link>
            </h4>
            <p className="font-light lg:font-normal text-base md:text-lg">
              A trailing beauty that adds a jungle feel to your home. Golden
              Pothos grows well in low light and can handle the occasional
              forgotten watering.
            </p>
          </div>
          <img
