    ...
    <div>
      ...
      <div className="flex flex-col items-center gap-50">
        ...
        <div
          ...
          "
        >
          <h3 className="font-semibold text-2xl md:text-[32px] self-end col-start-2">
            Common signs your plant needs help
          </h3>
          <div className="flex flex-col items-start justify-between row-start-2 row-span-7 col-start-2 gap-2 md:h-full md:pt-3">
            ...
            <h4 className="font-bold text-lg md:text-xl">Brown leaf edges</h4>
            <p className="text-left">
